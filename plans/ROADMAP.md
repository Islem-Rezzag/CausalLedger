...
- M02.01, M02.02, and M02.03 are `Completed and merged`; M02.04 is `QA passed, awaiting merge`; M02.05 through M02.20 remain `Not started`.
...
- The next recommended thread is `Merge M02.04 PR - Create apps/worker`.
