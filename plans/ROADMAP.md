...
Current submilestone status: M00.07 Milestone Closeout Workflow builder is complete and awaiting QA. M00.01 through M00.06 are completed and merged. M00 remains in progress.
...
- M00.07 builder work is complete and awaiting QA; it must not be marked QA passed or completed until QA PASS, PR merge, and post-merge tracking finalization occur.
