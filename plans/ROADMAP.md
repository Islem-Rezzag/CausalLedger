...
Current submilestone status: M00.01 through M00.08 are completed and merged. M01.01 through M01.13 are `Completed and merged`. M02.01 through M02.07 are `Completed and merged`; former M02.08 through M02.20 rows are deferred or absorbed. M03.01 through M03.03 are `Completed and merged`; M03.04 through M03.06 are `Not started`, and M04 through M21 remain `Not started`.
...
- The next recommended thread, after this finalization is merged into `main`, is `M03.04 Builder - MoneyEvent Validation and Normalization Rules`.
