...
Current submilestone status: M00.01 through M00.08 are completed and merged. M01.01 through M01.13 are `Completed and merged`. M02.01 through M02.07 are `Completed and merged`; former M02.08 through M02.20 rows are deferred or absorbed. M03.01 through M03.03 are `Completed and merged`; M03.04 is `QA passed, awaiting merge` on PR #53; M03.05 and M03.06 are `Not started`; M04 through M21 remain `Not started`.
...
- M03 planning and M03.01 through M03.03 are completed and merged; M03.03 finalization merged at `737710592544203e039ceee44a732e289c373bb6`. M03.04 is `QA passed, awaiting merge` on PR #53; M03.05 and M03.06 remain `Not started`.
...
- The next thread is `Merge M03.04 PR - MoneyEvent Validation and Normalization Rules`.
