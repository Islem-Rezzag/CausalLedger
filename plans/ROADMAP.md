...
- M02.01 through M02.05 are `Completed and merged`; M02.06 is `Builder complete, awaiting QA`; M02.07 remains `Not started`; former M02.08 through M02.20 rows are deferred or absorbed by the process amendment.
...
- The next recommended thread is `M02.06 QA - Local Infrastructure: Docker Compose, Postgres, Migration Tool, and Health-Check Stubs`.
