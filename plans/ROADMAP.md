...
- M02.01 through M02.06 are `Completed and merged`; M02.07 is `Builder complete, awaiting QA`; former M02.08 through M02.20 rows are deferred or absorbed by the process amendment.
...
- The next recommended thread is `M02.07 QA - QA Development Environment`.
