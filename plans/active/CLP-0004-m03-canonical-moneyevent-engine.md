...
- Two QA-control weaknesses were fixed: readiness claims are now checked inside their required sections and lifecycle/capability failure paths are mutation-tested; existing events tests now assert exactly 21 fixtures, eight valid snapshots, and 13 invalid issue contracts.
