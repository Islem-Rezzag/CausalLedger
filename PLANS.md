...
M02 is active under `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md`. M02 planning PR #37 merged into `main` at commit `18148f7`; M02.01 is `Completed and merged` after PR #38 merged into `main` at commit `fb2b901`; M02.02 is `Completed and merged` after PR #39 merged into `main` at commit `8ddf5da`; M02.03 is `Completed and merged` after PR #40 merged into `main` at commit `6ad4b0c`; M02.04 is `Completed and merged` after PR #41 merged into `main` at commit `f52396558e127e33e02c6e992d8a5f91cfe4dc0f`; M02 process amendment PR #42 merged into `main` at commit `d5c27c4`; M02.05 is `Completed and merged` after PR #43 merged into `main` at commit `6e76045`; M02.06 is `QA passed, awaiting merge`; M02.07 remains `Not started`; former M02.08 through M02.20 rows are deferred or absorbed.
