...
The domain model is not complete. Payment lifecycle vocabulary is defined in M01.01, ledger vocabulary is defined in M01.02, settlement vocabulary is defined in M01.03, reconciliation vocabulary is defined in M01.04, incident vocabulary is defined in M01.05, repair vocabulary is defined in M01.06, and remaining M01 domain areas are not yet defined.
