...
- `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md` - active M02 plan. M02.01 is `Completed and merged`, M02.02 is `QA passed, awaiting merge`, and M02.03 through M02.20 remain `Not started`.
