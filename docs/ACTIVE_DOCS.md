...
- `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md` - active M02 plan. M02.01 through M02.05 are `Completed and merged`; the process amendment is merged; M02.06 is `Builder complete, awaiting QA`; remaining active M02 work is M02.07 QA dev environment.
