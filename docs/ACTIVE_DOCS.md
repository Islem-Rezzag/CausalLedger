...
- `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md` - active M02 plan. M02.01 and M02.02 are `Completed and merged`, M02.03 is `QA passed, awaiting merge`, and M02.04 through M02.20 remain `Not started`.
