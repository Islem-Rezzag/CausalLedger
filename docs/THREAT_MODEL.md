...
M01.13 builder work verified `docs/DOMAIN_MODEL.md`, `docs/RELIABILITY.md`, `docs/THREAT_MODEL.md`, domain docs, eval docs, and status tracking for mutual consistency. QA PASS, PR merge, and M01 closeout remain required.
