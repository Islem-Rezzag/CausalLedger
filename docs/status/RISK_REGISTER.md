...
| Evidence semantics under-specified | Future incident behavior may lack audit rigor | M01.07 builder defined evidence receipt vocabulary, provenance, chain of custody, timestamp, redaction, uncertainty, conflict, gap, append-only, immutable raw evidence, derived evidence, audit-trail, and evidence-backed repair proposal boundaries as documentation only; future evidence bundle specs and runtime controls remain required before implementation | Open |
