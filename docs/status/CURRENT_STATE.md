...
- Top-level project docs for brief, vision, architecture, canonical M01 domain model summary, canonical CausalLedger reliability model, threat model, token cost strategy, and docs index.
