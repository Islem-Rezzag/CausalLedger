...
| Monorepo and local development | In progress | Active plan exists at `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md`; M02.01 through M02.04 are completed and merged, M02.05 is Builder complete awaiting QA, M02.06 and M02.07 remain Not started, and former M02.08 through M02.20 rows are deferred or absorbed |
...
| Package scaffolds, ESLint, and CI baseline | Builder complete, awaiting QA | M02.05 creates scaffold-only packages for core, events, ledger, invariants, incidents, graph, replay, repair, evidence, and evals; root ESLint is real ESLint; `.github/workflows/ci.yml` runs baseline validation; no product/domain behavior |
