...
| MoneyEvent engine | M03.02 Builder complete, awaiting QA | Active plan `plans/active/CLP-0004-m03-canonical-moneyevent-engine.md`; M03 planning PR #47 merged at `0606d3b21c05f2cf98397c9f5b0f1eddfa104a74`; M03.01 PR #48 merged at `babadf52762c407fc4d49c6e1d1b0b6cc0542b8e`; `docs/MONEYEVENT_CONTRACT.md` exists as conceptual documentation and `packages/events` contains a TypeScript-only type boundary; M03.03 through M03.06 are not started; no MoneyEvent runtime schema, parser, validator, normalizer, storage, fixture, simulator data, API, UI, or product behavior |
