...
| Monorepo and local development | In progress | Active plan exists at `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md`; M02.01 through M02.06 are completed and merged, M02.07 is Builder complete awaiting QA, and former M02.08 through M02.20 rows are deferred or absorbed |
...
| QA development environment | Builder complete, awaiting QA | M02.07 adds `pnpm qa:dev`, `scripts/qa-dev-environment.py`, and `docs/ops/qa-development-environment.md` for repeatable standard validation and explicit Docker opt-in; no product/domain behavior |
