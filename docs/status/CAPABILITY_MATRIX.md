...
| MoneyEvent engine | M03.06 Builder complete, awaiting QA | PR #55 merged M03.05 into `main` at `89874bca2525a423d773548c61f9655f09642575`, and PR #58 recovery QA merged at `721bd60eba04cdf71765660727132d0d6aed97bc`. `packages/events` contains compile-time types plus deterministic source-neutral candidate validation and normalization. M03.05 adds 21 controlled synthetic fixtures, seven early MoneyFlowBench seed cases, and strict test-only verification; structural and fixture success is not financial truth. M03.06 created the closeout-readiness candidate and passed local Builder validation, but independent QA and PR merge remain required. No source-specific parser or mapper, ingestion, storage, database, API, ledger, invariant, incident, graph, replay, repair, agent, connector, UI, benchmark scoring, or financial-truth behavior exists. M03 remains active. |
