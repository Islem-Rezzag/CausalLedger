...
| MoneyEvent engine | M03.04 completed and merged | PR #53 merged the independently reviewed M03.04 boundary into `main` at `572dc150e38782620416350004630b690c00e687`; QA passed at source commit `d8d13d588bd6471178b4d815556fe1ba7fff570c`. `packages/events` contains compile-time types plus deterministic source-neutral candidate validation and normalization; no source-specific parser, ingestion, storage, database, API, ledger, invariant, incident, graph, replay, repair, agent, connector, UI, or financial-truth behavior. M03.05 and M03.06 remain not started. |
