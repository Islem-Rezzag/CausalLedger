...
| Monorepo and local development | In progress | Active plan exists at `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md`; M02.01 through M02.06 are completed and merged, M02.07 is QA passed awaiting merge, and former M02.08 through M02.20 rows are deferred or absorbed |
