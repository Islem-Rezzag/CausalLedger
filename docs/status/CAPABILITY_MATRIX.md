...
| MoneyEvent engine | M03.05 completed and merged | PR #55 merged M03.05 into `main` at `89874bca2525a423d773548c61f9655f09642575`. `packages/events` contains compile-time types plus deterministic source-neutral candidate validation and normalization. M03.05 adds 21 controlled synthetic fixtures, seven early MoneyFlowBench seed cases, and strict test-only verification; structural and fixture success is not financial truth. No source-specific parser or mapper, ingestion, storage, database, API, ledger, invariant, incident, graph, replay, repair, agent, connector, UI, benchmark scoring, or financial-truth behavior exists. M03.06 remains not started. |
