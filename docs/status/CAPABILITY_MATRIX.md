...
| Ledger core | Not started (planning active) | `plans/active/CLP-0005-m04-double-entry-ledger-core.md` defines the M04 sequence; no ledger runtime or schema implementation |
