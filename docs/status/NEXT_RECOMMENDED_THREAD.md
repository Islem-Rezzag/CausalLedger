...
Precondition: The M01 planning PR from branch `m01-planning-domain-model-and-scope-freeze` has merged. M00.01 through M00.08 are `Completed and merged`, `v0.1.0` tags the M00 repo operating system foundation, `docs/status/M00_CLOSEOUT.md` exists, the completed M00 plan lives at `plans/completed/CLP-0001-m00-repo-operating-system.md`, and the active M01 plan exists at `plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md`.
