...
| M03.04 | MoneyEvent validation and normalization rules | M03 Canonical MoneyEvent engine | Builder complete, awaiting QA | plans/active/CLP-0004-m03-canonical-moneyevent-engine.md | m03-04-moneyevent-validation-normalization-rules |  | 2026-07-27: control-plane, 100 bootstrap tests, diff, frozen install, events package checks, full 13-package workspace checks, and dirty-mode QA passed | 2026-07-27 | Dependency-free source-neutral candidate validation and normalization implemented; separate QA required. No provider parser, ingestion, storage, database, API, ledger, incident, graph, replay, repair, agent, fixture corpus, benchmark, or money mutation. |
