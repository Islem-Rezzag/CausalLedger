...
| M03.04 | MoneyEvent validation and normalization rules | M03 Canonical MoneyEvent engine | QA passed, awaiting merge | plans/active/CLP-0004-m03-canonical-moneyevent-engine.md | m03-04-moneyevent-validation-normalization-rules | #53 | 2026-07-28: independent QA fixed the UTC year-range boundary; control plane, 101 bootstrap tests, 66 events tests, frozen install, package/workspace checks, diff, and dirty-mode QA passed | 2026-07-28 | QA PASS; scoped deterministic validator/normalizer is safe to merge after remote checks. No provider parser, ingestion, storage, database, API, ledger, incident, graph, replay, repair, agent, fixture corpus, benchmark, or money mutation. |
