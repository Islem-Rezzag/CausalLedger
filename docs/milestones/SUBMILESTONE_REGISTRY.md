...
| M02.01 | Choose backend and frontend stack | M02 Monorepo and local development | Builder complete, awaiting QA | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-01-choose-backend-and-frontend-stack |  | 2026-06-08: builder validation passed; validate-control-plane passed; pytest 32 passed; git diff --check passed; make unavailable | 2026-06-08 | Stack direction documented in ADR-0005 and ADR-0006; previous planning state was Not started. No product implementation, dependency installation, apps/api runtime, apps/web runtime, database behavior, MoneyEvent behavior, or M02.02 work. |
