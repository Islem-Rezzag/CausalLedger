...
| M03.04 | MoneyEvent validation and normalization rules | M03 Canonical MoneyEvent engine | Completed and merged | plans/active/CLP-0004-m03-canonical-moneyevent-engine.md | m03-04-moneyevent-validation-normalization-rules | #53 | 2026-07-28: PR #53 merge confirmed at `572dc150e38782620416350004630b690c00e687`; QA source `d8d13d588bd6471178b4d815556fe1ba7fff570c`; finalization control plane, 101 bootstrap tests, 66 events tests, frozen install, package/workspace checks, diff, and dirty-mode QA passed | 2026-07-28 | Completed after QA PASS and merge. Scoped deterministic validator/normalizer only; no provider parser, ingestion, storage, database, API, ledger, incident, graph, replay, repair, agent, fixture corpus, benchmark, or money mutation. |
