...
| M02.05 | Create all remaining package scaffolds + ESLint + CI baseline | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Process amendment in progress; implementation validation not run because the submilestone has not started | 2026-06-11 | Scope: packages/core, packages/events, packages/ledger, packages/invariants, packages/incidents, packages/graph, packages/replay, packages/repair, packages/evidence, packages/evals, package manifests, tsconfig only, placeholder bootstrap test each, root ESLint baseline, and GitHub Actions CI baseline. Absorbs former M02.06 through M02.13 and former M02.19. Former M02.05 apps/agent-runtime creation is deferred to the M10 era. |
| M02.06 | Local infrastructure: Docker Compose + Postgres + migration tool + health-check stubs | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Process amendment in progress; implementation validation not run because the submilestone has not started | 2026-06-11 | Absorbs former M02.14, M02.16, M02.17, and M02.18. No product database behavior exists yet. |
| M02.07 | QA dev environment | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Process amendment in progress; implementation validation not run because the submilestone has not started | 2026-06-11 | Corresponds to former M02.20 and validates the restructured M02 local development foundation. |
