...
| M00.04 | Builder and QA prompt protocol | M00 Repo operating system | QA passed, awaiting merge | plans/active/CLP-0001-m00-repo-operating-system.md | m00-04-builder-and-qa-prompt-protocol |  | 2026-05-08 QA validation passed | 2026-05-08 | QA passed; protocol and templates verified; safe to merge after PR review. |
