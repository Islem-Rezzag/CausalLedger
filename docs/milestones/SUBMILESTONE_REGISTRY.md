...
| M00.03 | Planning and tracking system | M00 Repo operating system | QA passed, awaiting merge | plans/active/CLP-0001-m00-repo-operating-system.md | m00-03-planning-and-tracking-system |  | 2026-05-06 QA validation passed | 2026-05-06 | QA PASS after scoped post-merge finalization guidance fix and control-plane validation; not complete until PR merge. |
