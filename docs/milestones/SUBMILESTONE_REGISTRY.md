...
| M01.03 | Define settlement vocabulary | M01 Domain model and scope freeze | Builder complete, awaiting QA | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-03-define-settlement-vocabulary | Pending | 2026-05-15: builder validation passed; validate-control-plane passed; pytest 20 passed; git diff --check passed; make unavailable | 2026-05-15 | Domain documentation only; no settlement runtime, reconciliation logic, schemas, invariants, incidents, graph, replay, connectors, or product behavior; do not mark QA passed until QA review. |
