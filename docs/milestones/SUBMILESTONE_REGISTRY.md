...
| M01.13 | QA domain consistency | M01 Domain model and scope freeze | QA passed, awaiting merge | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-13-qa-domain-consistency | #35 open | 2026-05-25: QA validation passed; validate-control-plane passed; pytest passed; git diff --check passed; make unavailable; QA verified docs/status/M01_DOMAIN_CONSISTENCY.md, DOMAIN_MODEL.md, RELIABILITY.md, THREAT_MODEL.md, eval docs, spec placeholders, roadmap, registry, active plan, and status docs are consistent; fixed checked-file list to include the report itself; confirmed M01 active, M02-M21 Not started, product implementation not started | 2026-05-25 | Documentation/control-plane consistency QA only. No product implementation, runtime schema, API, database, UI, connector, GitHub Action, CI workflow, deployment, auth/authz runtime, or product behavior. M01 closeout still required after M01.13 PR merge. |
