...
| M01.01 | Define payment lifecycle | M01 Domain model and scope freeze | Completed and merged | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-01-qa-recovery-define-payment-lifecycle | #11; QA recovery PR pending | 2026-05-11: post-merge QA recovery passed; validate-control-plane passed; pytest 18 passed; git diff --check passed; make unavailable | 2026-05-11 | Builder PR #11 was squash-merged before required QA at commit 1175789; post-merge QA recovery records PASS, no product implementation, and merge of the QA recovery PR is required before M01.02. |
