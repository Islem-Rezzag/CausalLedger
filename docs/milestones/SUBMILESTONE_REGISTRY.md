...
| M00.04 | Builder and QA prompt protocol | M00 Repo operating system | Builder complete, awaiting QA | plans/active/CLP-0001-m00-repo-operating-system.md | m00-04-builder-and-qa-prompt-protocol |  | 2026-05-08 builder validation passed | 2026-05-08 | Builder created reusable prompt protocol and templates; awaiting same-branch QA. |
