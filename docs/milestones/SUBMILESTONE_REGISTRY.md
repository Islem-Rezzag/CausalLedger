...
| M03.05 | MoneyEvent test fixtures and benchmark seed cases | M03 Canonical MoneyEvent engine | QA passed, awaiting merge | plans/active/CLP-0004-m03-canonical-moneyevent-engine.md | m03-05-moneyevent-test-fixtures-benchmark-seeds | #55 | 2026-07-31: independent QA; control plane; 102 bootstrap tests; 97 events tests; 42 evals tests; package/workspace checks; diff; data hygiene; boundary review; and dirty-mode QA passed | 2026-07-31 | PR #55 is open after independent QA PASS. The reviewed scope has 21 controlled fixtures, seven exact-grounded seeds, strict test-only manifest parsers, full snapshots, and exact issues. No mapper, runner, scoring, simulator execution, ingestion, storage, downstream financial behavior, or money mutation. |
