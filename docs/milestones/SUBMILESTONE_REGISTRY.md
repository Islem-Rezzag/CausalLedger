...
| M01.09 | Define out-of-scope domains | M01 Domain model and scope freeze | QA passed, awaiting merge | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-09-define-out-of-scope-domains |  | 2026-05-21: QA validation passed; validate-control-plane passed; pytest 27 passed; git diff --check passed; make unavailable | 2026-05-21 | Domain documentation only; QA passed after reviewing hard out-of-scope domains, adjacent-but-not-core domains, forbidden product claims, LLM forbidden actions, future-extension rules, interview and product positioning boundaries, examples, tracking, and validation coverage. No product implementation or runtime out-of-scope behavior. |
