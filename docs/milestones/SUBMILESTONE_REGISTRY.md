...
| M01.05 | Define incident vocabulary | M01 Domain model and scope freeze | QA passed, awaiting merge | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-05-qa-recovery-incident-vocabulary-ablation-strategy | Recovery PR pending | 2026-05-16: post-merge QA recovery passed; validate-control-plane passed; pytest 23 passed; git diff --check passed; make unavailable | 2026-05-16 | Builder PR #16 was squash-merged before required QA at commit 5c3943b; QA recovery passed, awaiting recovery PR merge; domain vocabulary documentation plus explicitly scoped ablation roadmap/evaluation planning only; no product implementation or runtime behavior. |
