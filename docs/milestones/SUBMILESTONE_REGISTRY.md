...
| M01.01 | Define payment lifecycle | M01 Domain model and scope freeze | Builder complete, awaiting QA | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-01-define-payment-lifecycle |  | 2026-05-11: validate-control-plane passed; pytest 18 passed; git diff --check passed; make unavailable | 2026-05-11 | Payment lifecycle domain docs created; no product implementation |
