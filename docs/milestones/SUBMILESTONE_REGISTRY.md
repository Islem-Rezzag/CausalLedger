...
| M03.06 | MoneyEvent QA and closeout | M03 Canonical MoneyEvent engine | Not started | plans/active/CLP-0004-m03-canonical-moneyevent-engine.md |  |  | 2026-06-30: M03.02 builder confirmed not started | 2026-06-30 | Planned scope only; QA and closeout must verify forbidden scope, deterministic tests, docs alignment, and merge readiness before M03 can complete. |
