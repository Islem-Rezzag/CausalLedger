...
| M01.07 | Define evidence receipt model | M01 Domain model and scope freeze | Builder complete, awaiting QA | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-07-define-evidence-receipt-model |  | 2026-05-18: builder validation passed; validate-control-plane passed; pytest 25 passed; git diff --check passed; make unavailable | 2026-05-18 | Domain documentation only; defined evidence receipt vocabulary, provenance, chain of custody, timestamps, freshness, retention, redaction, confidentiality, uncertainty, confidence, limitations, conflicts, coverage, gaps, evidence bundles, receipt statuses, rejection reasons, append-only handling, immutable raw evidence boundaries, derived evidence boundaries, audit trails, safety boundaries, and moat rationale. No product implementation or runtime evidence behavior. |
