...
| M01.06 | Define safe and unsafe repairs | M01 Domain model and scope freeze | Builder complete, awaiting QA | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-06-define-safe-and-unsafe-repairs |  | 2026-05-17: builder validation passed; validate-control-plane passed after scoped next-thread wording fix; pytest passed (24 tests); git diff --check passed | 2026-05-17 | Domain documentation only; defined safe and unsafe repair vocabulary, proposal-only repair boundaries, repair evidence requirements, deterministic validation expectations, replay-before-apply, idempotency, rollback, human approval, escalation, repair categories, and forbidden autonomous repair actions. No product implementation or runtime repair behavior. |
