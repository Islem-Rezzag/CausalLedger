...
Status values: Not started, Builder in progress, Builder complete, awaiting QA, QA passed, awaiting merge, Completed and merged, Blocked, Deferred.
...
| M01.13 | QA domain consistency | M01 Domain model and scope freeze | Completed and merged | plans/completed/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-13-qa-domain-consistency | #35 merged | 2026-05-25: QA validation passed before merge; validate-control-plane passed; pytest 30 passed; git diff --check passed; make unavailable; PR #35 merged at commit 27c39b6; QA verified docs/status/M01_DOMAIN_CONSISTENCY.md, DOMAIN_MODEL.md, RELIABILITY.md, THREAT_MODEL.md, eval docs, spec placeholders, roadmap, registry, active plan, and status docs are consistent; fixed checked-file list to include the report itself; confirmed M01 active at QA time, M02-M21 Not started, product implementation not started | 2026-05-25 | Documentation/control-plane consistency QA only. No product implementation, runtime schema, API, database, UI, connector, GitHub Action, CI workflow, deployment, auth/authz runtime, or product behavior. M01 closeout passed after PR #35 merge. |
| M02.01 | Choose backend and frontend stack | M02 Monorepo and local development | Completed and merged | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-01-choose-backend-and-frontend-stack | #38 merged | 2026-06-08: QA validation passed before merge; validate-control-plane passed; pytest 32 passed; git diff --check passed; make unavailable; PR #38 merged at commit fb2b901 | 2026-06-08 | Stack direction documented in ADR-0005 and ADR-0006; PR #38 merged into main at commit fb2b901. Documentation-only stack decision; no product implementation, dependency installation, apps/api runtime, apps/web runtime, database behavior, MoneyEvent behavior, or M02.02 work was created by M02.01. |
| M02.02 | Create apps/api | M02 Monorepo and local development | Completed and merged | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-02-create-apps-api | #39 merged | 2026-06-09: PR #39 merged into main at commit 8ddf5da; QA validation passed before merge; validate-control-plane passed after scoped next-thread fix; pytest 32 passed; git diff --check passed; pnpm install passed with non-blocking esbuild approve-builds warning; pnpm typecheck passed; pnpm test 1 passed; pnpm build passed; pnpm lint passed; pnpm format:check passed; make unavailable | 2026-06-09 | Minimal non-domain apps/api TypeScript/Fastify foundation, workspace manifests, lockfile, app factory, server entrypoint, and bootstrap test completed and merged. No product/domain routes, health checks, database, auth/authz, connector, CI workflow, Docker Compose, MoneyEvent, ledger, incident, evidence, replay, graph, repair, or product behavior. |
| M02.03 | Create apps/web | M02 Monorepo and local development | Completed and merged | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-03-create-apps-web | #40 merged | 2026-06-09: PR #40 merged into main at commit 6ad4b0c; QA validation passed before merge; validate-control-plane passed; pytest 32 passed; git diff --check passed; pnpm install passed with non-blocking esbuild approve-builds warning; pnpm typecheck passed; pnpm test 2 passed; pnpm build passed; pnpm lint passed; pnpm format:check passed; optional dev-server smoke passed; make unavailable | 2026-06-09 | Minimal non-domain apps/web React/Vite foundation with package scripts, Vite config, TypeScript configs, HTML entrypoint, React bootstrap component, browser render entrypoint, README, and bootstrap test completed and merged. No CausalLedger dashboard, product UI, API calls, routing, auth/authz, database, connector, chart, MoneyEvent, ledger, incident, evidence, replay, graph, repair, or product behavior. |
| M02.04 | Create apps/worker | M02 Monorepo and local development | Completed and merged | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-04-create-apps-worker | #41 merged | 2026-06-11: PR #41 merged into main at commit f52396558e127e33e02c6e992d8a5f91cfe4dc0f after QA PASS; validate-control-plane passed; pytest 32 passed; git diff --check passed; pnpm install passed with no esbuild approve-builds warning emitted; pnpm typecheck passed; pnpm test 3 passed; pnpm build passed; pnpm lint passed; pnpm format:check passed; make unavailable | 2026-06-11 | Minimal non-domain apps/worker TypeScript foundation with package scripts, TypeScript config, bootstrap module, README, and bootstrap test completed and merged. No jobs, queues, schedulers, provider connectors, database, MoneyEvent, ledger, invariant, incident, evidence, replay, graph, repair, health-check, CI workflow, Docker Compose, or product behavior. |
| M02.05 | Create all remaining package scaffolds + ESLint + CI baseline | M02 Monorepo and local development | Completed and merged | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-05-package-scaffolds-eslint-ci | #43 merged | 2026-06-24: PR #43 merged into main at commit 6e76045 after QA validation and GitHub Actions CI passed | 2026-06-24 | Package scaffolds remain metadata-only; no product/domain behavior. |
| M02.06 | Local infrastructure: Docker Compose + Postgres + migration tool + health-check stubs | M02 Monorepo and local development | Completed and merged | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-06-local-infra-postgres-migrations-health | #44 merged | 2026-06-24: PR #44 merged into main at commit 80ce206 after QA validation and remote infra-smoke passed | 2026-06-24 | Local-only Docker Compose/Postgres, node-pg-migrate commands, empty migration boundary, env placeholders, and /infra/ready process readiness stub; no product database schema. |
| M02.07 | QA dev environment | M02 Monorepo and local development | Completed and merged | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-07-qa-development-environment | #45 merged | 2026-06-25: PR #45 merged into main at commit 4a4f381adb7ed263fb26d0373f00043f2fe6a6bc after QA validation; remote validate and infra-smoke passed on merge commit | 2026-06-25 | QA corrected truthful dirty-worktree, repository-local identity, deterministic Docker environment, flow-control, CI proof, and behavioral-test coverage; no product/domain behavior. |
| M02.08 | Former package scaffold slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.05. |
| M02.09 | Former package scaffold slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.05. |
| M02.10 | Former package scaffold slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.05. |
| M02.11 | Former package scaffold slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.05. |
| M02.12 | Former package scaffold slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.05. |
| M02.13 | Former package scaffold slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.05. |
| M02.14 | Former Postgres slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.06. |
| M02.15 | Former Redis slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Redis is deferred until needed; no queue or scheduler should be added before the worker or orchestration design proves the need. |
| M02.16 | Former Docker Compose slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.06. |
| M02.17 | Former migrations slice | M02 Monorepo and local development | Deferred | plans/completed/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | Deferred by 2026-06-11 process amendment | 2026-06-11 | Absorbed into redefined M02.06. |
...
| M03.01 | Canonical MoneyEvent concept and contract planning | M03 Canonical MoneyEvent engine | Completed and merged | plans/completed/CLP-0004-m03-canonical-moneyevent-engine.md | m03-01-moneyevent-concept-contract | #48 | 2026-09-24: PR #59 merge proof reconfirmed; formal closeout PR #60 merged; M04 planning separately active | 2026-08-18 | Completed conceptual contract documentation; no runtime schemas, source parsers, storage, simulator execution, routes, UI, or downstream financial behavior. |
| M03.02 | MoneyEvent TypeScript types and schema boundary | M03 Canonical MoneyEvent engine | Completed and merged | plans/completed/CLP-0004-m03-canonical-moneyevent-engine.md | m03-02-moneyevent-types-schema-boundary | #49 | 2026-09-24: PR #59 merge proof reconfirmed; formal closeout PR #60 merged; M04 planning separately active | 2026-08-18 | Completed the `packages/events` TypeScript type boundary; structural types do not establish financial truth. |
| M03.03 | Evidence-to-MoneyEvent mapping fixtures and simulator planning | M03 Canonical MoneyEvent engine | Completed and merged | plans/completed/CLP-0004-m03-canonical-moneyevent-engine.md | m03-03-evidence-to-moneyevent-fixtures-simulator-planning | #51 | 2026-09-24: PR #59 merge proof reconfirmed; formal closeout PR #60 merged; M04 planning separately active | 2026-08-18 | Documentation-only mapping and simulator planning; no source mapper, simulator execution, autonomous loop, or product behavior. |
| M03.04 | MoneyEvent validation and normalization rules | M03 Canonical MoneyEvent engine | Completed and merged | plans/completed/CLP-0004-m03-canonical-moneyevent-engine.md | m03-04-moneyevent-validation-normalization-rules | #53 | 2026-09-24: PR #59 merge proof reconfirmed; formal closeout PR #60 merged; M04 planning separately active | 2026-08-18 | Dependency-free source-neutral deterministic candidate validation and normalization only; no financial interpretation, posting, or money mutation. |
| M03.05 | MoneyEvent test fixtures and benchmark seed cases | M03 Canonical MoneyEvent engine | Completed and merged | plans/completed/CLP-0004-m03-canonical-moneyevent-engine.md | m03-05-moneyevent-test-fixtures-benchmark-seeds | #55; finalization #56; duplicate no-op #57; recovery #58 | 2026-08-18: formal closeout reconfirmed identical PR #56/#57 trees and merged recovery #58 | 2026-08-18 | Contains 21 controlled fixtures and seven grounded seed metadata records with strict test-only verification. No mapper, benchmark runner, scoring, simulator execution, downstream financial behavior, or money mutation. |
| M03.06 | MoneyEvent QA and closeout | M03 Canonical MoneyEvent engine | Completed and merged | plans/completed/CLP-0004-m03-canonical-moneyevent-engine.md | m03-06-moneyevent-qa-closeout | #59 | 2026-08-18: PR #59 merge `9c2df34fd1da1a4f893a5b16cb05fa1177f23cce`, tree equality, empty diffs, prior QA PASS, and exact-head CI proved | 2026-08-18 | Independent QA passed before human squash merge. Formal closeout PR #60 is merged; `docs/status/M03_CLOSEOUT.md` records the verified merge and the completed plan remains under plans/completed. M04 through M21 remain not started. |
| M04.01 | Define Account schema | M04 Double-entry ledger core | QA passed, awaiting merge | plans/active/CLP-0005-m04-double-entry-ledger-core.md | m04-01-account-schema | #62 | Independent QA PASS; 191 control-plane + 117 ledger tests; clean QA 18/0/1; final-SHA record in PR #62 | 2026-09-24 | Planning PR #61 reviewed and merged; Account metadata schema/validation implemented on branch; no posting/storage; independent QA PASS; human merge pending. |
| M04.02 | Define LedgerTransaction schema | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.03 | Define LedgerEntry schema | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.04 | Enforce debit equals credit | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.05 | Add immutable transaction storage | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.06 | Add account balance query | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.07 | Add transaction query | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.08 | Add idempotency keys | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.09 | Add reversal transaction type | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.10 | Add cash clearing account | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.11 | Add provider clearing account | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.12 | Add customer liability account | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.13 | Add fee expense account | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.14 | Add revenue account | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.15 | Add tests for balanced posting | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.16 | Add tests for invalid posting | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.17 | Add reversal tests | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
| M04.18 | QA ledger core | M04 Double-entry ledger core | Not started | plans/active/CLP-0005-m04-double-entry-ledger-core.md |  |  |  | 2026-09-24 | Planned only; implementation waits for planning QA and human merge. |
