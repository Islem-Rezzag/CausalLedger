...
| M03.03 | Evidence-to-MoneyEvent mapping fixtures and simulator planning | M03 Canonical MoneyEvent engine | QA passed, awaiting merge | plans/active/CLP-0004-m03-canonical-moneyevent-engine.md | m03-03-evidence-to-moneyevent-fixtures-simulator-planning | #51 | 2026-07-08: QA validation passed; mapping fixture plan, loop strategy, package boundaries, forbidden scope, control-plane, pytest, diff, events package checks, workspace checks, and dirty-mode QA passed | 2026-07-08 | `docs/MONEYEVENT_MAPPING_FIXTURES.md` defines controlled evidence families, planned fixture categories, mapping principles, simulator planning, and verifier-driven loop strategy alignment; no fixture data, simulator data, real connectors, evidence storage, live ingestion, parser, validator, normalizer, API, UI, ledger, replay, repair, autonomous loop, agent runtime, or product behavior. |
| M03.04 | MoneyEvent validation and normalization rules | M03 Canonical MoneyEvent engine | Not started | plans/active/CLP-0004-m03-canonical-moneyevent-engine.md |  |  | 2026-06-30: M03.02 builder confirmed not started | 2026-06-30 | Planned scope only; deterministic validation and normalization rules for identity, idempotency, money, currency, timestamps, source references, provenance, duplicates, missing evidence, and conflicts; no LLM judgment as validation. |
