...
| M00.06 | GitHub PR and issue workflow | M00 Repo operating system | Builder complete, awaiting QA | plans/active/CLP-0001-m00-repo-operating-system.md | m00-06-github-pr-and-issue-workflow |  | 2026-05-09 builder validation passed | 2026-05-09 | Created GitHub PR, issue, label, milestone, and branch protection workflow artifacts; awaiting QA. |
