...
| M03.05 | MoneyEvent test fixtures and benchmark seed cases | M03 Canonical MoneyEvent engine | Builder complete, awaiting QA | plans/active/CLP-0004-m03-canonical-moneyevent-engine.md | m03-05-moneyevent-test-fixtures-benchmark-seeds |  | 2026-07-31: control plane, 102 bootstrap tests, 71 events tests, 5 evals tests, package/workspace checks, diff, fixture/seed safety inspection, and dirty-mode QA passed | 2026-07-31 | Controlled deterministic candidate fixtures and early MoneyFlowBench seed metadata are implemented with test-only verification. No mapper, benchmark runner, scoring, simulator execution, ingestion, storage, downstream financial behavior, or money mutation. Independent QA and merge remain required. |
