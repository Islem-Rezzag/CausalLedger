...
| M01.02 | Define ledger vocabulary | M01 Domain model and scope freeze | Builder complete, awaiting QA | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-02-define-ledger-vocabulary | Pending | 2026-05-15: builder validation passed after scoped vocabulary-list fix; validate-control-plane passed; pytest 19 passed; git diff --check passed; make unavailable; commit message docs: define M01.02 ledger vocabulary | 2026-05-15 | Domain documentation only; product implementation has not started. |
