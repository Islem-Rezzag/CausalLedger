...
| M02.05 | Create all remaining package scaffolds + ESLint + CI baseline | M02 Monorepo and local development | Builder complete, awaiting QA | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-05-package-scaffolds-eslint-ci |  | 2026-06-24: builder validation passed after scoped install rerun; package typecheck, forced ESLint and lint, tests, and build passed; control-plane validation and pytest 40 passed; git diff --check passed; make unavailable | 2026-06-24 | Builder created scaffold-only packages/core, packages/events, packages/ledger, packages/invariants, packages/incidents, packages/graph, packages/replay, packages/repair, packages/evidence, and packages/evals; added real ESLint and CI baseline; no product/domain behavior. |
| M02.06 | Local infrastructure: Docker Compose + Postgres + migration tool + health-check stubs | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | 2026-06-24: M02 process amendment QA passed; implementation validation not run because the submilestone has not started | 2026-06-24 | Absorbs former M02.14, M02.16, M02.17, and M02.18. No product database behavior exists yet. |
| M02.07 | QA dev environment | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | 2026-06-24: M02 process amendment QA passed; implementation validation not run because the submilestone has not started | 2026-06-24 | Corresponds to former M02.20 and validates the restructured M02 local development foundation. |
