...
| M01.02 | Define ledger vocabulary | M01 Domain model and scope freeze | QA passed, awaiting merge | plans/active/CLP-0002-m01-domain-model-and-scope-freeze.md | m01-02-define-ledger-vocabulary | Pending | 2026-05-15: QA validation passed; validate-control-plane passed; pytest 19 passed; git diff --check passed; make unavailable; QA commit message test: QA M01.02 ledger vocabulary | 2026-05-15 | Domain documentation only; product implementation has not started; do not mark completed until PR merge. |
