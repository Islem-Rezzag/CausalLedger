...
| M02.01 | Choose backend and frontend stack | M02 Monorepo and local development | QA passed, awaiting PR merge | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-01-choose-backend-and-frontend-stack | #38 | 2026-06-08: QA validation passed; validate-control-plane passed; pytest 32 passed; git diff --check passed; make unavailable | 2026-06-08 | Stack direction documented in ADR-0005 and ADR-0006; PR #38 is safe for human merge after QA PASS; previous planning state was Not started. No product implementation, dependency installation, apps/api runtime, apps/web runtime, database behavior, MoneyEvent behavior, or M02.02 work. |
| M02.02 | Create apps/api | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-02-create-apps-api`; no API implementation in planning thread. |
