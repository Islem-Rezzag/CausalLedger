...
| M00.05 | Validation and handoff workflow | M00 Repo operating system | QA passed, awaiting merge | plans/active/CLP-0001-m00-repo-operating-system.md | m00-05-validation-and-handoff-workflow |  | 2026-05-09 QA validation passed | 2026-05-09 | QA PASS recorded after validation and forbidden-scope checks; awaiting PR merge. |
