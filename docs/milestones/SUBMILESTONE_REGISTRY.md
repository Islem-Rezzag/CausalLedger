...
| M00.06 | GitHub PR and issue workflow | M00 Repo operating system | QA passed, awaiting merge | plans/active/CLP-0001-m00-repo-operating-system.md | m00-06-github-pr-and-issue-workflow |  | 2026-05-09 QA validation passed | 2026-05-09 | QA PASS recorded for GitHub PR, issue, label, milestone, and branch protection workflow artifacts; awaiting PR merge and post-merge finalization. |
| M00.07 | Milestone closeout workflow | M00 Repo operating system | Not started |  |  |  |  |  |  |
