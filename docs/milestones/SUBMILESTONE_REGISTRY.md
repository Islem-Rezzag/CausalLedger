...
| M04.01 | Define Account schema | M04 Double-entry ledger core | Builder complete, awaiting QA | plans/active/CLP-0005-m04-double-entry-ledger-core.md | m04-01-account-schema |  | 191 control-plane + 117 ledger tests PASS; full workspace QA 17/0/2 | 2026-09-24 | Planning PR #61 reviewed and merged; Account metadata schema/validation implemented on branch; no posting/storage; awaiting independent QA. |
