...
| M02.04 | Create apps/worker | M02 Monorepo and local development | QA passed, awaiting merge | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md | m02-04-create-apps-worker | #41 | 2026-06-11: QA validation passed; validate-control-plane passed; pytest 32 passed; git diff --check passed; pnpm install passed with no esbuild approve-builds warning emitted; pnpm typecheck passed; pnpm test 3 passed; pnpm build passed; pnpm lint passed; pnpm format:check passed; make unavailable | 2026-06-11 | Minimal non-domain apps/worker TypeScript foundation with package scripts, TypeScript config, bootstrap module, README, and bootstrap test. QA expanded README command/scope documentation only. No jobs, queues, schedulers, provider connectors, database, MoneyEvent, ledger, invariant, incident, evidence, replay, graph, repair, health-check, CI workflow, Docker Compose, or product behavior. |
| M02.05 | Create apps/agent-runtime | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-05-create-apps-agent-runtime`; no agent runtime implementation in planning thread. |
| M02.06 | Create packages/core | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-06-create-packages-core`; no package implementation in planning thread. |
| M02.07 | Create packages/events | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-07-create-packages-events`; no MoneyEvent runtime implementation in planning thread. |
| M02.08 | Create packages/ledger | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-08-create-packages-ledger`; no ledger runtime implementation in planning thread. |
| M02.09 | Create packages/invariants | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-09-create-packages-invariants`; no invariant implementation in planning thread. |
| M02.10 | Create packages/incidents | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-10-create-packages-incidents`; no incident runtime implementation in planning thread. |
| M02.11 | Create packages/graph | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-11-create-packages-graph`; no graph runtime implementation in planning thread. |
| M02.12 | Create packages/replay | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-12-create-packages-replay`; no replay runtime implementation in planning thread. |
| M02.13 | Create packages/repair | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-13-create-packages-repair`; no repair planner runtime implementation in planning thread. |
| M02.14 | Add Postgres | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-14-add-postgres`; no database implementation in planning thread. |
| M02.15 | Add Redis | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-15-add-redis`; no runtime Redis setup in planning thread. |
| M02.16 | Add Docker Compose | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-16-add-docker-compose`; no Docker Compose implementation in planning thread. |
| M02.17 | Add migrations | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-17-add-migrations`; no migration implementation in planning thread. |
| M02.18 | Add health checks | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-18-add-health-checks`; no health check implementation in planning thread. |
| M02.19 | Add CI baseline | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-19-add-ci-baseline`; no GitHub Actions or CI workflow in planning thread. |
| M02.20 | QA dev environment | M02 Monorepo and local development | Not started | plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md |  |  | M02 planning in progress; implementation validation not run because the submilestone has not started | 2026-06-02 | Expected branch `m02-20-qa-dev-environment`; QA starts only after M02.01 through M02.19 complete and merge. |
