...
def closeout_state_errors():
    ...
    if (
        "Builder complete, awaiting QA" not in m02_02_row
        or "m02-02-create-apps-api" not in m02_02_row
    ):
        errors.append("M02.02 is not recorded as builder complete on the expected branch")
    ...
    if "M02.02 QA - Create apps/api" not in next_thread:
        errors.append("Next recommended thread is not M02.02 QA")
    ...
    if "Do not start M02.03 until M02.02 QA passes" not in next_thread:
