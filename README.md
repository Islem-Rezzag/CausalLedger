...
- `apps/`: future deployable services; `apps/api` has a minimal non-domain TypeScript/Fastify scaffold, while other app directories remain placeholders.
