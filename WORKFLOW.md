...
Current active milestone plan: `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md`. The completed M01 plan lives at `plans/completed/CLP-0002-m01-domain-model-and-scope-freeze.md`; M02 planning, M02.01 through M02.04, and the M02 process amendment are merged. M02.05 is `Builder complete, awaiting QA`, and M02.06 must not start until M02.05 QA passes, the M02.05 PR merges, and post-merge tracking is finalized.
