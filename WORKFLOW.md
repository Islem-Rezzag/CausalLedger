...
Current active milestone plan: `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md`. The completed M01 plan lives at `plans/completed/CLP-0002-m01-domain-model-and-scope-freeze.md`; M02 planning and M02.01 are merged, M02.02 is `Builder complete, awaiting QA`, and M02.03 must not start until M02.02 QA passes, the M02.02 PR merges, and post-merge tracking is finalized.
