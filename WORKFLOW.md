...
Current active milestone plan: `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md`. The completed M01 plan lives at `plans/completed/CLP-0002-m01-domain-model-and-scope-freeze.md`; M02 planning, M02.01 through M02.05, and the M02 process amendment are merged. M02.06 is `Builder complete, awaiting QA`, and M02.07 must not start until M02.06 QA passes, the M02.06 PR merges, and post-merge tracking is finalized.
