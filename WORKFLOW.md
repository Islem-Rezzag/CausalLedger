...
Current active milestone plan: `plans/active/CLP-0003-m02-monorepo-and-local-development-environment.md`. The completed M01 plan lives at `plans/completed/CLP-0002-m01-domain-model-and-scope-freeze.md`; M02 planning and M02.01 through M02.04 are merged, and M02.05 must not start until the process-amendment PR merges and post-merge tracking is finalized.
