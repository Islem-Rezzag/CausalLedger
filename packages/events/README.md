...
No CausalLedger product or domain behavior is implemented here. There are no MoneyEvent schemas, financial schemas, ledger entries, balances, invariants, incident workflows, graph traversal, replay algorithms, repair logic, evidence storage, benchmark behavior, external connectors, agents, database behavior, or money mutation.
